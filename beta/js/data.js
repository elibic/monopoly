...
(function () {
  ...
  const FINANCE = {
    DEPOSIT_CHUNKS: [50, 100, 200],
    BANK_START: 50000,          // ההון של בנק מונופול בתחילת המשחק
    FEE_RATE: 0.01,             // דמי ניהול לסבב — על פיקדון ומניות בלבד
    BANK_INVEST_SHARE: 0.30,    // איזה חלק מהון הבנק מושקע בבורסה // סכומי הפקדה קבועים — לוחצים, לא מקלידים
